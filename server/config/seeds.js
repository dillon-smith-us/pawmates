  ...
  const products = await Product.insertMany([
    {
      name: 'Spot',
      description:
        'Spot is a friendly great dane in need of more friends!',
      image: 'greatdane.jpg',
    ...
    },
    {
      ...
      description:
        'Indy is a terrier looking for friends in Plymouth!',
      image: 'terrier.jpg',
      zipcode: 55987,
      quantity: 20
    },
    ...
    },
    {
      ...
      description:
        'Bella is 4 months old! needs puppy playmates now!!',
    ...
    },
    {
      name: 'Zoe',
      category: categories[0]._id,
      description: 'Zoe is a pyranese pup 2 months old. Would love to find other large breed pups for zoe to play with.',
      image: 'pyranese.jpg',
      zipcode: 55411,
      quantity: 1000
    },
